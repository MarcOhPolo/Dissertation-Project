This project presents a comprehensive evaluation of machine learning and anomaly
...
Models (GMM). This project details the tools and techniques used to create, train, and test
the models.
...
By comparing these models across DNS, hardware, and local network datasets, this project
